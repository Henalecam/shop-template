		...
		<div className="min-h-[60vh] bg-white text-gray-900" style={{ fontFamily: "Impact, sans-serif" }}>
			...
			<main className="max-w-5xl mx-auto px-4 py-8">
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
					{products.map((p) => (
						<div key={p.id} className="bg-white border-[3px] border-black rounded overflow-hidden flex flex-col">
							<img src={p.image_url || "https://via.placeholder.com/600x400?text=Skate"} alt={p.name} className="h-48 w-full object-cover" />
